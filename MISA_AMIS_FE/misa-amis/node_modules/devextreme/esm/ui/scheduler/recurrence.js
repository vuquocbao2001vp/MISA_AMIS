...
class RecurrenceProcessor {
    ...
    _convertRruleResult(rruleIntervalParams, options, rruleDate) {
        var convertedBackDate = timeZoneUtils.setOffsetsToDate(rruleDate, [timeZoneUtils.getClientTimezoneOffset(rruleDate), -options.appointmentTimezoneOffset, rruleIntervalParams.startIntervalDateDSTShift]);
